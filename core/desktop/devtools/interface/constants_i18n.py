...
LANG_PACK = {
    "en": {
        ...
        "NAV_STATUS_HINT": "q — exit | r — refresh | Enter — details | Space — done | e — edit | x — delete | g — Git Projects",
        "OFFSET_LABEL": " | Offset: ",
    ...
    "ru": {
        ...
        "NAV_STATUS_HINT": "q — выход | r — обновить | Enter — детали | Space — готово | e — редактировать | x — удалить | g — Git Projects",
    ...
    "uk": {
        ...
        "FILTER_ALL": "ВСІ",
        "FILTER_BACKLOG": "ЧЕРГА",
        "FILTER_DONE": "ГОТОВО",
        "FILTER_IN_PROGRESS": "В РОБОТІ",
        ...
        "NAV_STATUS_HINT": "q — вихід | r — оновити | Enter — деталі | Space — готово | e — редагувати | x — видалити | g — Git Projects",
        ...
        "STATUS_MESSAGE_CLI_UPDATED": "↻ CLI: завдання оновлено (зовнішня зміна)",
